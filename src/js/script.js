//esta informacion es para el funcionamiento de emailjs, y quedaria expuesta en GitHub.
const PUBLIC_KEY = "4Y77DFjgko8rvBzwf";
const ID_TEMPLATE = "template_a4yygd8";
const ID_SERVICE = "service_iuya47f";


console.log('escuchando el DOMContentLoaded');
...
//! Para mantener el JSON como un archivo separado y consumirlo dinámicamente, necesitarías usar 
//! JavaScript. fetch() es una opción común y moderna para esto
